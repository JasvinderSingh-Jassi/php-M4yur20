...
### Scema(Attributes) : 1. id(Primary Key), 2. email(User Email), 3. hash(For verification purposes), 4. is_active(For the purpose of sending email only to subscribed users). 
